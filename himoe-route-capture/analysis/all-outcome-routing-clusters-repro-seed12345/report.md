...
|---|---|---:|---|---:|---|---:|---:|---:|---:|---|---|---:|---|
| geometry | stable_partition | 2 | 1536/1024 | 0.403 | 1.000/1.000 | 0.000 | 0.035 | 0.035 | 0.000 | 1.0000/1.0000 | no | 0.590 | task_shadowed |
| change | stable_partition | 2 | 2294/266 | 0.334 | 0.931/0.898 | 0.043 | 0.005 | 0.013 | -0.008 | 0.9990/1.0000 | no | 0.198 | task_shadowed |
| recurrence | stable_partition | 6 | 101/874/231/525/268/561 | 0.351 | 0.970/0.938 | 0.032 | 0.105 | 0.078 | 0.028 | 0.0002/0.0002 | no | 0.693 | task_shadowed |
| expert_occupancy | stable_partition | 6 | 512/134/470/472/478/494 | 0.259 | 0.982/0.969 | 0.006 | 0.219 | 0.127 | 0.092 | 0.0002/0.0002 | yes | 0.871 | outcome_structured+task_shadowed+secondary_expert_id_view |
...
| change | C0 | 2294 | 2005 | 289 | 0.126 | 0.223 | 9/13.0/52 |
| change | C1 | 266 | 248 | 18 | 0.068 | 0.996 | 22/39.0/52 |
...
| expert_occupancy | C1 | 134 | 7 | 127 | 0.948 | 1.000 | 47/52.0/52 |
...
| expert_occupancy | C5 | 494 | 314 | 180 | 0.364 | 0.765 | 13/39.0/52 |
...
| expert_occupancy | stable_partition/4 | stable_partition/6 | 0.603 | 0.000 | 0.414 | 0.000 | 1.806 | reorganized |
...
| change | -0.046 | 0.436 | -0.044 | 0.090 | 0.038 |
| recurrence | 0.750 | 0.709 | 0.884 | 0.516 | 0.803 |
| expert_occupancy | 0.000 | 0.961 | 0.751 | 0.771 | 0.516 |
...
| change | KITCHEN_SCENE8_put_both_moka_pots_on_the_stove | 216 | 0.329 | 0.0002 | 0.0004 |
| change | pick_up_the_black_bowl_on_the_ramekin_and_place_it_on_the_plate | 12 | 0.000 | 1.0000 | 1.0000 |
| change | pick_up_the_black_bowl_on_the_stove_and_place_it_on_the_plate | 37 | 0.036 | 0.0298 | 0.0477 |
...
| expert_occupancy | KITCHEN_SCENE8_put_both_moka_pots_on_the_stove | 216 | 0.205 | 0.0002 | 0.0004 |
...
| change | grid5 | 2 | 0.838 | 2252/308 | yes | -0.013 | 1.0000 |
| change | truncate90 | 2 | 0.836 | 2332/228 | yes | -0.009 | 1.0000 |
| recurrence | grid5 | 6 | 0.675 | 101/1046/222/535/267/389 | yes | 0.048 | 0.0006 |
...
|---|---:|---:|---:|---:|
| geometry | 1.000 | -0.026 | 0.427 | 0.304 |
| change | -0.026 | 1.000 | 0.054 | 0.044 |
| recurrence | 0.427 | 0.054 | 1.000 | 0.554 |
| expert_occupancy | 0.304 | 0.044 | 0.554 | 1.000 |
