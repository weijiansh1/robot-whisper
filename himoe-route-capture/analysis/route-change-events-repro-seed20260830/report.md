...
|---:|---:|---:|---:|---:|:---:|
| 2 | 703 | 0.325 | 0.823 / 0.792 | 0.142 | true |
| 3 | 214 | 0.355 | 0.835 / 0.801 | 0.124 | true |
| 4 | 205 | 0.370 | 0.865 / 0.829 | 0.099 | true |
| 5 | 205 | 0.331 | 0.872 / 0.842 | 0.085 | true |
| 6 | 50 | 0.336 | 0.864 / 0.768 | 0.128 | false |
| 7 | 50 | 0.318 | 0.853 / 0.689 | 0.137 | false |
| 8 | 50 | 0.323 | 0.928 / 0.894 | 0.065 | false |
...
- `events_over_task`: AUC increment 0.226 (cluster-bootstrap 95% CI 0.124 to 0.373); AP increment 0.679 (CI 0.519 to 0.795).

- `events_over_task_length`: AUC increment -0.002 (cluster-bootstrap 95% CI -0.005 to 0.000); AP increment -0.002 (CI -0.023 to 0.023).
