...
|---:|---:|---:|---:|---:|:---:|
| 2 | 703 | 0.317 | 0.819 / 0.782 | 0.104 | true |
| 3 | 214 | 0.349 | 0.833 / 0.799 | 0.105 | true |
| 4 | 205 | 0.369 | 0.862 / 0.828 | 0.098 | true |
| 5 | 205 | 0.331 | 0.869 / 0.836 | 0.080 | true |
| 6 | 50 | 0.336 | 0.865 / 0.686 | 0.150 | false |
| 7 | 50 | 0.320 | 0.851 / 0.673 | 0.139 | false |
| 8 | 50 | 0.317 | 0.925 / 0.903 | 0.056 | false |
...
- `events_over_task`: AUC increment 0.226 (cluster-bootstrap 95% CI 0.128 to 0.356); AP increment 0.679 (CI 0.484 to 0.793).

- `events_over_task_length`: AUC increment -0.002 (cluster-bootstrap 95% CI -0.006 to 0.000); AP increment -0.002 (CI -0.024 to 0.024).
