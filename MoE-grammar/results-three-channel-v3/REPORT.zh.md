...
在 held-out 成功序列上，soft HMM 的完整前缀相对仅按内部时钟推进的 next-query 改善为 0.0118 bits/phenotype；连续 VAR(4) 相对无历史 Gaussian 的改善为 0.2174 bits/phenotype。

这只证明 routing history 可预测下一 query，不自动证明高 surprisal 等于 Trap。

健康 excursion 的局部 return 任务含 87247 个 held-out 异常前缀；三步不返回的 AUC 为 0.571，return-probability Brier 为 0.095。
...
|---|---:|---:|---:|---:|---:|
| current_innovation | 4.7% | 4.1% | 5.1% | 5.1% | 0.557 [0.509, 0.605] |
| var_innovation | 4.7% | 3.0% | 3.6% | 3.6% | 0.558 [0.511, 0.604] |
| hmm_innovation | 4.7% | 2.0% | 3.0% | 3.0% | 0.546 [0.499, 0.594] |
| innovation_persistent | 4.7% | 5.6% | 7.6% | 8.6% | 0.524 [0.490, 0.560] |
| overregularity | 4.7% | 4.6% | 4.6% | 5.1% | 0.509 [0.457, 0.560] |
| overregularity_persistent | 4.7% | 5.1% | 5.1% | 5.6% | 0.482 [0.459, 0.506] |
| return_failure | 4.7% | 2.0% | 2.0% | 2.5% | 0.510 [0.464, 0.559] |
| three_channel | 4.7% | 5.1% | 5.1% | 5.6% | 0.526 [0.479, 0.576] |

### Over-regularity components

| component | success episode FPR | recall q-3 | recall by onset | matched AUC (95% CI over events) |
|---|---:|---:|---:|---:|
| freeze | 4.7% | 4.1% | 4.6% | 0.508 [0.459, 0.557] |
| recurrence | 4.7% | 5.1% | 5.1% | 0.517 [0.465, 0.570] |
| low_belief_entropy | 0.0% | 0.0% | 0.0% | 0.529 [0.475, 0.583] |
...
|---|---:|---:|---:|
| current_innovation | 10.8% | 3.6% | 0.557 [0.509, 0.605] |
| var_innovation | 12.8% | 3.6% | 0.558 [0.511, 0.604] |
| hmm_innovation | 8.4% | 2.0% | 0.546 [0.499, 0.594] |
| innovation_persistent | 10.8% | 11.2% | 0.524 [0.490, 0.560] |
| overregularity | 4.7% | 4.6% | 0.509 [0.457, 0.560] |
| overregularity_persistent | 4.4% | 3.6% | 0.482 [0.459, 0.506] |
| return_failure | 5.7% | 3.6% | 0.510 [0.464, 0.559] |
| three_channel | 4.4% | 4.6% | 0.526 [0.479, 0.576] |
