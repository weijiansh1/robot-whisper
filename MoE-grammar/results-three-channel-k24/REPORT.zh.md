...
在 held-out 成功序列上，soft HMM 的完整前缀相对仅按内部时钟推进的 next-query 改善为 0.0146 bits/phenotype；连续 VAR(4) 相对无历史 Gaussian 的改善为 0.2174 bits/phenotype。

这只证明 routing history 可预测下一 query，不自动证明高 surprisal 等于 Trap。

健康 excursion 的局部 return 任务含 83212 个 held-out 异常前缀；三步不返回的 AUC 为 0.568，return-probability Brier 为 0.102。
...
|---|---:|---:|---:|---:|---:|
| current_innovation | 4.7% | 2.5% | 3.6% | 3.6% | 0.559 [0.510, 0.607] |
| var_innovation | 4.7% | 2.5% | 3.0% | 3.0% | 0.563 [0.517, 0.608] |
| hmm_innovation | 4.7% | 3.6% | 4.6% | 4.6% | 0.544 [0.497, 0.589] |
| innovation_persistent | 4.7% | 6.1% | 7.1% | 8.6% | 0.493 [0.465, 0.523] |
| overregularity | 4.7% | 4.1% | 4.1% | 4.6% | 0.516 [0.460, 0.570] |
| overregularity_persistent | 4.7% | 5.6% | 5.6% | 6.1% | 0.481 [0.458, 0.505] |
| return_failure | 4.7% | 4.1% | 4.1% | 4.1% | 0.532 [0.486, 0.581] |
| three_channel | 4.7% | 6.1% | 6.1% | 6.6% | 0.531 [0.485, 0.579] |

### Over-regularity components

| component | success episode FPR | recall q-3 | recall by onset | matched AUC (95% CI over events) |
|---|---:|---:|---:|---:|
| freeze | 4.4% | 3.6% | 3.6% | 0.501 [0.452, 0.551] |
| recurrence | 4.7% | 5.6% | 5.6% | 0.519 [0.467, 0.572] |
| low_belief_entropy | 0.0% | 0.0% | 0.0% | 0.527 [0.474, 0.579] |
...
|---|---:|---:|---:|
| current_innovation | 7.1% | 3.6% | 0.559 [0.510, 0.607] |
| var_innovation | 7.4% | 2.5% | 0.563 [0.517, 0.608] |
| hmm_innovation | 8.4% | 2.0% | 0.544 [0.497, 0.589] |
| innovation_persistent | 9.8% | 8.6% | 0.493 [0.465, 0.523] |
| overregularity | 4.7% | 4.1% | 0.516 [0.460, 0.570] |
| overregularity_persistent | 6.1% | 3.0% | 0.481 [0.458, 0.505] |
| return_failure | 6.8% | 4.1% | 0.532 [0.486, 0.581] |
| three_channel | 6.1% | 4.1% | 0.531 [0.485, 0.579] |
