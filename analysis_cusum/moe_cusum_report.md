...
(W=1)** and **B 84.2% / 89.5%**; per-group AUC at t=30, W=8 ranges 0.851–0.920 (A, 2 eligible groups) and
0.551–0.917 (B, 6 eligible groups). The late separation is broad across branches.
