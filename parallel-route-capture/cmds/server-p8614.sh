#!/bin/bash
# route-recorder server: suite=goal gpu=2 port=8614
...
exec /home/jovyan/.cache/himoe-libero-bridge/envs/model/bin/python -u /home/jovyan/work/himoe-vla/himoe-route-capture/serve_with_recorder.py \
  --host 127.0.0.1 --port 8614 --gpu 2 --suite goal \
  ...
  --store-full-probs \
  --out /home/jovyan/work/himoe-vla/VLA_MUI_HUB/cache_new/HiMoE-VLA/libero_goal/put_the_bowl_on_top_of_the_cabinet/rolling-star-k16-20260903/server
