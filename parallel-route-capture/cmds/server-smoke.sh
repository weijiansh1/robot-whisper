#!/bin/bash
# route-recorder server: suite=long gpu=0 port=8650
...
exec /home/jovyan/.cache/himoe-libero-bridge/envs/model/bin/python -u /home/jovyan/work/himoe-vla/himoe-route-capture/serve_with_recorder.py \
  --host 127.0.0.1 --port 8650 --gpu 0 --suite long \
  ...
  --store-full-probs \
  --out /home/jovyan/work/himoe-vla/parallel-route-capture/runs/parcap-20260903/smoke/server
