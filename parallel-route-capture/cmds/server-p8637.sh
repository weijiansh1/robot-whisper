#!/bin/bash
# route-recorder server: suite=object gpu=7 port=8637
...
exec /home/jovyan/.cache/himoe-libero-bridge/envs/model/bin/python -u /home/jovyan/work/himoe-vla/himoe-route-capture/serve_with_recorder.py \
  --host 127.0.0.1 --port 8637 --gpu 7 --suite object \
  ...
  --store-full-probs \
  --out /home/jovyan/work/himoe-vla/VLA_MUI_HUB/cache_new/HiMoE-VLA/libero_object/pick_up_the_milk_and_place_it_in_the_basket/rolling-star-k16-20260903/server
