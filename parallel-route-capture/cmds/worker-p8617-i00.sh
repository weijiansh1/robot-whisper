#!/bin/bash
# worker worker-p8617-i00: libero_goal task 7 init 0
...
exec env PYTHONPATH=/home/jovyan/work/himoe-libero-wrist-fix/src:/home/jovyan/.cache/himoe-libero-bridge/upstream/HiMoE-VLA/packages/openpi-client/src \
  ...
  --out /home/jovyan/work/himoe-vla/VLA_MUI_HUB/cache_new/HiMoE-VLA/libero_goal/turn_on_the_stove/rolling-star-k16-20260903/client/init-00
