#!/bin/bash
# route-recorder server: suite=goal gpu=3 port=8619
...
exec /home/jovyan/.cache/himoe-libero-bridge/envs/model/bin/python -u /home/jovyan/work/himoe-vla/himoe-route-capture/serve_with_recorder.py \
  --host 127.0.0.1 --port 8619 --gpu 3 --suite goal \
  ...
  --store-full-probs \
  --out /home/jovyan/work/himoe-vla/VLA_MUI_HUB/cache_new/HiMoE-VLA/libero_goal/put_the_wine_bottle_on_the_rack/rolling-star-k16-20260903/server
