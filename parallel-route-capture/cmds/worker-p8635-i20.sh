#!/bin/bash
# worker worker-p8635-i20: libero_object task 5 init 20
...
exec env PYTHONPATH=/home/jovyan/work/himoe-libero-wrist-fix/src:/home/jovyan/.cache/himoe-libero-bridge/upstream/HiMoE-VLA/packages/openpi-client/src \
  ...
  --host 127.0.0.1 --port 8635 \
  --benchmark libero_object --task-id 5 \
  ...
  --out /home/jovyan/work/himoe-vla/VLA_MUI_HUB/cache_new/HiMoE-VLA/libero_object/pick_up_the_tomato_sauce_and_place_it_in_the_basket/rolling-star-k16-20260903/client/init-20
