#!/bin/bash
# worker worker-p8610-i20: libero_goal task 0 init 20
...
exec env PYTHONPATH=/home/jovyan/work/himoe-libero-wrist-fix/src:/home/jovyan/.cache/himoe-libero-bridge/upstream/HiMoE-VLA/packages/openpi-client/src \
  ...
  --host 127.0.0.1 --port 8610 \
  --benchmark libero_goal --task-id 0 \
  ...
  --out /home/jovyan/work/himoe-vla/VLA_MUI_HUB/cache_new/HiMoE-VLA/libero_goal/open_the_middle_drawer_of_the_cabinet/rolling-star-k16-20260903/client/init-20
