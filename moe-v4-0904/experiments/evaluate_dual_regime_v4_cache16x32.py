...
DEFAULT_DUAL_PROFILE = BUNDLE / "results/cache_new_v4/deployment_profiles.npz"
DEFAULT_LEGACY_PROFILE = (
    CANONICAL / "results/online_precision_cascade_external/deployment_profiles.npz"
)
DEFAULT_OUTPUT = BUNDLE / "results/cache16x32_v4"
RUN_ID = "right-16x32"
MAX_QUERY = 52
