#!/usr/bin/env python3
"""Audit the frozen mode run, decoding fixed-width JSON entry labels explicitly."""
...
def audit_task(run, task, plan):
    ...
    for arm in ARMS:
        ...
        require(text(probe["mode"]) == entry_mode == branch["entry_mode"].rstrip("\x00"), "Pre-treatment mode")
