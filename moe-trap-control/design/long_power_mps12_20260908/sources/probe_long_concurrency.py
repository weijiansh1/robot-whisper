...
def run(args):
    ...
    if any(count not in (1, 2, 4, 8, 12, 16) or count > args.replicas for count in args.counts):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--replicas", type=int, choices=(1, 2, 4, 8, 12, 16), default=4)
