#!/usr/bin/env python3
"""Isolated CUDA-IPC replicas for the v8 feature intervention experiment."""
...
from v8_feature_control import V8FeaturePolicy
...
def serve(args, endpoints, policies, uuid, replica, owner):
    ...
    for endpoint in endpoints:
        ...
        bound[endpoint.name] = DeviceBoundPolicy(V8FeaturePolicy(policy), 0, executor)
    try:
...
def main():
    ...
    if args.gpu not in (0, 1, 2, 3):
        parser.error("This experiment is restricted to physical GPUs 0,1,2,3")
